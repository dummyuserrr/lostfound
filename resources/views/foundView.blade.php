		...
		<div class="right">			
			<div class="grouper">
				<div class="box">
					...
					<div class="markAsFound" data-type="found" title="Mark as Retrieved" data-itemID="{{ $item->id }}">
					...
					<div class="posts">
						...
						<div class="right">
							...
							<p class="texts">
								...
								<span class="name">{{ $item->datefound }}</span>
							</p>
							<p class="texts">
								<span class="label">Time Found: </span>
								<span class="name">{{ date('g:i A', strtotime($item->timefound)) }}</span>
							</p>
							@if($item->user_id == session('id') || session('role') == 'admin' || session('role') == 'superadmin')
							<p class="texts">
						...
						<div class="post_comments">
							...
							<div class="commentbox">
								<form method="post" action="/found-something/{{ $item->id }}/comment/add" class="comment_form">
									{{ csrf_field() }}
