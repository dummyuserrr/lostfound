<div class="commentcontainer cc{{ $comment->id }}">
	...
	<div class="post_comments_right">
		<p class="comment">
			...
			<a href="javascript:;" class="deletelink" data-type="found" data-itemID="{{ $comment->found_item_id }}" data-commentID="{{ $comment->id }}"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
			@endif
